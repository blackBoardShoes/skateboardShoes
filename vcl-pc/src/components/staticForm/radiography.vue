<template>
  <div class='all'>
    <el-form size="mini"
      ...
      label-width="0px">
      <el-form-item label="是否造影" prop="radiographyOrNot" label-width="100px">
        <el-radio-group v-model="contentModel.radiographyOrNot">
          <el-radio label="是"></el-radio>
          <el-radio label="否"></el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="造影管道" prop="radiographyPipeline" label-width="100px">
