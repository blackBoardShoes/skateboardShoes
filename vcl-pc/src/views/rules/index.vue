        ...
        fields: [
          ...
          // },
          {
            ...
            values: [
              ...
              {value: '日间手术病房', label: '日间手术病房'},
              {value: '传染科', label: '传染科'},
              {value: '儿保中心', label: '儿保中心'},
              {value: '耳鼻咽喉—头颈外科', label: '耳鼻咽喉—头颈外科'},
              {value: '放射治疗科', label: '放射治疗科'},
              {value: '风湿病科', label: '风湿病科'},
              {value: '妇产科', label: '妇产科'},
              {value: '骨科', label: '骨科'},
              {value: '骨质疏松科', label: '骨质疏松科'},
              {value: '呼吸科', label: '呼吸科'},
              {value: '急诊科', label: '急诊科'},
              {value: '康复科', label: '康复科'},
              {value: '口腔科', label: '口腔科'},
              {value: '老年病二科', label: '老年病二科'},
              {value: '老年病三科', label: '老年病三科'},
              {value: '老年病一科', label: '老年病一科'},
              {value: '泌尿二科', label: '泌尿二科'},
              {value: '泌尿外科', label: '泌尿外科'},
              {value: '内分泌科', label: '内分泌科'},
              {value: '普外三科', label: '普外三科'},
              {value: '普外四科', label: '普外四科'},
              {value: '乳腺病科', label: '乳腺病科'},
              {value: '神经内科', label: '神经内科'},
              {value: '神经外科', label: '神经外科'},
              {value: '肾病科', label: '肾病科'},
              {value: '特需病房（内科）', label: '特需病房（内科）'},
              {value: '消化科', label: '消化科'},
              {value: '小儿内科', label: '小儿内科'},
              {value: '心血管内科', label: '心血管内科'},
              {value: '心血管外科', label: '心血管外科'},
              {value: '胸外科', label: '胸外科'},
              {value: '血液科', label: '血液科'},
              {value: '眼科', label: '眼科'},
              {value: '中医科', label: '中医科'},
